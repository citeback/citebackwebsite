...
export const campaigns = [
  ...
  // National Campaigns — Active litigation and advocacy
  {
    id: 8,
    type: 'legal',
    title: 'Legal Fund — SIREN & CAIR-CA v. City of San Jose',
    description: 'San Jose PD operates 500 Flock cameras that ran 3,965,519 plate searches between June 2024 and June 2025 — none required a warrant. Data is retained for a full year. EFF and the ACLU of Northern California filed suit in November 2025 on behalf of SIREN (immigrant rights) and CAIR-CA (Muslim civil rights) — two communities whose members are most exposed to warrantless location tracking. This fund backs their litigation directly.',
    winCondition: "Court rules San Jose's Flock ALPR network requires a warrant — 3.96 million annual warrantless searches stopped",
    ...
    backers: 0,
    deadline: '2026-12-01',
    tags: ['legal', 'ALPR', 'Flock Safety', 'California', 'Fourth Amendment', 'EFF', 'ACLU'],
    source: 'https://www.eff.org/cases/siren-v-san-jose',
    contractContext: "Flock Safety (FLOCK GROUP INC) holds federal contracts. San Jose's 500-camera deployment is a local contract. EFF's audit of Flock logs revealed 3.96M searches across a single year — none required a warrant. Source: EFF / USASpending.gov",
  },
  {
    id: 9,
    type: 'legal',
    title: 'Legal Fund — Schmidt v. Norfolk (4th Circuit)',
    description: "In May 2024, a Virginia trial court ruled that Norfolk's 172-camera Flock network is a 'dragnet over the entire city' — legally equivalent to GPS tracking — and requires a warrant. The prosecution appealed. The case is now before the Fourth Circuit Court of Appeals. ACLU and EFF filed amicus briefs in April 2026. If the 4th Circuit affirms, it sets binding precedent across Virginia, Maryland, North Carolina, South Carolina, and West Virginia. This is the most consequential Flock case in the country right now.",
    winCondition: '4th Circuit affirms: Flock ALPR networks require warrants — binding precedent covering five states',
    location: 'Norfolk, VA',
    goal: 8000,
    raised: 0,
    walletXMR: null,
    ...
    backers: 0,
    deadline: '2026-12-01',
    tags: ['legal', 'ALPR', 'Flock Safety', 'Virginia', 'Fourth Amendment', 'Fourth Circuit'],
    source: 'https://www.aclu.org/cases/schmidt-v-norfolk',
    contractContext: "Institute for Justice leads the challenge; ACLU + EFF filed amicus April 2026. A 4th Circuit ruling creates binding precedent for 5 states and would directly undermine Flock's sales model across the Southeast. Source: ACLU / EFF",
  },
  {
    id: 10,
    type: 'advocacy',
    title: 'Advocacy — Fight for the Future: Flock Out',
    description: "Fight for the Future and 38 coalition partners are dismantling Flock Safety's ALPR rollout city by city. 60+ cities have already terminated or paused contracts — including Denver, Austin, and Eugene — after sustained pressure campaigns. The latest front: Lowe's, one of Flock's largest corporate clients. A major protest hit Flock HQ in Atlanta in April 2026. This fund supports the national campaign infrastructure: legal toolkit distribution, city council organizing, and direct action at Flock's corporate enablers.",
    winCondition: "Lowe's terminates its Flock contract; 100+ total city/corporate terminations documented",
    location: 'National',
    goal: 5000,
    raised: 0,
    walletXMR: null,
    ...
    backers: 0,
    deadline: '2026-10-01',
    tags: ['advocacy', 'ALPR', 'Flock Safety', 'national', 'grassroots'],
    source: 'https://www.fightforthefuture.org/actions/flockout/',
    contractContext: 'Flock Safety ALPR cameras feed data to ICE, CBP, and other federal agencies — documented by EFF FOIA requests. Each city termination severs another node from the federal surveillance network. Vigilant Solutions / DRN provides parallel commercial ALPR access to ICE. Source: EFF / USASpending.gov',
  },
...
export const typeColors = {
  ...
  advocacy: { bg: 'rgba(46,204,113,0.1)', border: 'rgba(46,204,113,0.3)', text: '#2ecc71', label: 'Advocacy' },
}
