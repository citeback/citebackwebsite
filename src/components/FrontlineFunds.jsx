...
const funds = [
  {
    ...
    what: 'San Jose PD\'s 500 Flock cameras ran 3,965,519 plate searches in a single year — none required a warrant. EFF and ACLU-NorCal filed suit in November 2025 on behalf of immigrant and Muslim civil rights orgs. In March 2026, the San Jose City Council voted to adopt new ALPR guardrails — but plaintiffs say the changes don\'t end warrantless police searches of location data, the core issue. Active litigation continues in Santa Clara County Superior Court.',
    ...
    status: 'Active — City adopted partial guardrails Mar 2026, warrantless search challenge ongoing',
    tag: 'Lawsuit',
  },
  {
    id: 2,
  ...
  },
  {
    ...
    status: 'Active — Williams $500K settlement Mar 2026; Ortiz-led class action ongoing',
    tag: 'Class Action',
  },
  {
    id: 4,
    org: 'ACLU of Michigan',
    title: 'Woodruff v. Oliver — Facial Recognition Wrongful Arrest',
    what: 'Detroit\'s Real Time Crime Center used facial recognition to identify and arrest Porcha Woodruff — a Black woman 8 months pregnant — for a carjacking she didn\'t commit. She was held 11 hours. The ACLU and ACLU Michigan filed an amicus brief in December 2024 arguing that an FRT match, and any photo lineup built on it, cannot supply probable cause. In September 2025, the district court dismissed the case on qualified immunity grounds, despite calling the circumstances "troubling." Woodruff\'s attorney has indicated intent to appeal. ACLU Michigan continues fighting facial recognition abuse in Detroit.',
    why: 'The landmark facial recognition wrongful arrest case in the US. The district court\'s dismissal on qualified immunity is itself a warning sign — supporting ACLU Michigan\'s ongoing work pressures police departments to change FR policies regardless of whether courts grant relief.',
    donateUrl: 'https://www.aclumich.org/donate/',
    donateLabel: 'Support ACLU Michigan',
    status: 'Dismissed — district court dismissed Sept 2025 on qualified immunity; appeal anticipated',
    tag: 'Lawsuit',
  },
  {
    id: 5,
