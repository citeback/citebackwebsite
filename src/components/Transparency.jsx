...
const principles = [
  ...
  { title: 'Platform Holds Collection Wallets', body: 'Each campaign has two wallet types: a platform-controlled collection wallet (where contributions arrive — no operator access) and the operator\'s own payout address (where funds land after a successful campaign). No operator can access contribution funds before a campaign succeeds. Attempting to do so results in permanent blacklisting.' },
