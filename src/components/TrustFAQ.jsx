  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: `Anyone can vote by signing their vote with a Monero private key or Nostr key. This proves identity without revealing it.\n\nVoting weight is earned through donation history — not wallet count. This makes Sybil attacks costly:\n\n• Below 0.5% of campaign goal donated → no voting weight\n• 0.5%–8% of goal → full 1:1 weight\n• 8%–20% of goal → diminishing returns\n• Above 20% of goal → capped (funding is unlimited; governance weight is not)\n\nThresholds scale with campaign size — attacking a large legal fund costs proportionally more than attacking a small billboard campaign. Only wallets with donation history before a proposal was submitted can vote on it. You cannot flood a vote at the last minute.\n\nAn AI governance monitor watches for coordinated patterns and can propose parameter adjustments if gaming is detected.\n\nDifferent decisions require different thresholds:\n• Campaign proposals: simple majority, 24hr review\n• Disbursement challenges: 60% to block (default is release)\n• Rule changes: 60–75% supermajority + 7–14 day time-lock`,
      },
      {
