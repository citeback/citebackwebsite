...
const campaigns = [
  {
    ...
    description:
      'Force disclosure through FOIA litigation. Every case creates a permanent, citable record that feeds future campaigns.',
    highlight:
      'Brennan Center v. NYPD exposed an entire surveillance unit.',
    highlightLabel: 'Example',
  },
  {
    name: 'Ordinance Campaigns',
    description:
      'City council campaigns to ban or regulate surveillance locally. 50+ cities have passed bans since Oakland\'s 2018 ordinance.',
    highlight:
      "Ban the Scan's model legislation is now deployed in cities across the US.",
    highlightLabel: 'Example',
  },
  {
    ...
    highlight:
      'Amazon pulled Rekognition from police after sustained accountability campaigns.',
    highlightLabel: 'Result',
  },
  {
    name: 'Counter-Database Projects',
    description:
      'Map and document surveillance infrastructure publicly. The data that feeds litigation, journalism, and legislation.',
    highlight:
      "EFF's Atlas of Surveillance changed procurement conversations in dozens of cities.",
    highlightLabel: 'Example',
  },
  {
    name: 'Insurance Pressure',
    description:
      'Document harms to liability insurers of surveillance contractors. Make surveillance tech uninsurable — the most underexplored tool in the space.',
    highlight:
