const facts = [
  'Citeback never holds funds — contributions go directly to the campaign organizer\'s own wallet. Platform monitors balance via view key (read-only).',
  ...
  'Early drain = permanent ban — campaign organizers who withdraw funds before campaign completion are permanently blacklisted with a public misconduct record',
  ...
  'OFAC screening on all campaign organizers — required before any campaign goes live and again at each disbursement',
      ...
      <div className="guarantee-grid">
        ...
        <div>
          ...
          <div className="guarantee-headline">
            Citeback never holds funds. Contributions go directly to campaign organizers. Platform monitors via view key.
          </div>

          <div className="guarantee-paragraphs">
            {[
              'Campaign organizers hold their own campaign wallets under the direct wallet model. Citeback never holds, pools, or touches campaign funds.',
              'Every campaign wallet publishes a view key — a read-only key that lets anyone independently verify the balance. Citeback monitors via the same view key and permanently bans any campaign organizer who drains early.',
