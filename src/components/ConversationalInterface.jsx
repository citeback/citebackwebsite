...
const STATIC_RESPONSES = {
  ...
  'Who controls the wallets?':
    'Campaign organizers control their own campaign wallets — that is the direct wallet model. Contributions go straight to the organizer\'s own XMR or ZANO wallet. Citeback never holds keys, never pools funds, and cannot move money. Accountability comes from view key monitoring (anyone can verify the balance in real time), permanent bans for early withdrawal, and OFAC/identity pre-screening of all campaign organizers. The full architecture is published on GitHub and independently auditable. Wallets activate at Phase 2 launch.',
  'Is this legal?':
  ...
  'How do I propose a campaign?':
    'Go to the "Run a Campaign" section to review requirements and prepare your proposal. Campaign organizers must verify their real identity privately with the platform\'s legal entity — your name is never published on-chain or in any public forum. The platform operator reviews proposals for legal viability and alignment with the mission. Once approved, a campaign wallet will be provisioned and the campaign will go live. Note: organizer identity verification is required; contributor anonymity is separate and fully preserved.',
  'What is ALPR?':
