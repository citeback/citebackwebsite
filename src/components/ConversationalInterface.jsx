...
const STATIC_RESPONSES = {
  ...
  'Who controls the wallets?':
    'No human will, by design. Wallet keys are held in a multi-party threshold system across a minimum of three independent nodes in separate locations — no single party can act alone. The full architecture is published openly and independently auditable. Wallets activate at Phase 2 launch.',
  'Is this legal?':
